...
// Question Number:43.Unchanged Magicians: Start with your work from Exercise 40. Call the
...
function make_great2(magicians: string[]): string[] {
    ...
    for (let i =0; i < magicians.length; i++) { //i stand for index string
        greatMagicians.push(magicians[i] = magicians[i] +  ' the Great');
    }
    return greatMagicians;
}

const magicians3: string[] = ["Ali","Hamza","Aswad"];
